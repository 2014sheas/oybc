...
### B2 — Play-surface extraction (the god-file pair) — `L`
...
### B3 — Database access seams (dependency injection) — `M/L`
...
### B4 — Enforce the sync-enqueue choke point — `M`
...
### E3 — Test the seams (the PR #202 lesson, generalized) — `M`, after B-track
