...
- **Scope:** pick one (**static** — see the Decision bullet below) and write the rule into both `docs/RISO_UI_CHECKLIST.md` and `docs/RISO_WEB.md`; convert the iOS sites to the static token.
