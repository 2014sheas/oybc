...
- **Scope:** pick one (the 2026-09 audit's T2 fix takes **static**) and write the rule into both `docs/RISO_UI_CHECKLIST.md` and `docs/RISO_WEB.md`; convert the iOS sites to the static token.
